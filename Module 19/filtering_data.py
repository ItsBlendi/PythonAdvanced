...
if submit_button:
    new_data = {
        ...
        'Reviews': new_reviews,  # ✅ FIXED
        'Price': new_price,
        'Year': new_year,
        'Genre': new_genre
    }

    book_df = pd.concat([pd.DataFrame([new_data]), book_df], ignore_index=True)
...
fig = px.pie(
    ...
    color='Genre',
    color_discrete_sequence=px.colors.sequential.Plasma  # ✅ FIXED
)
